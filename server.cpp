...
//For later project to be used for handling multiple clients
...
#pragma region Database Setup
    ...
    rc = sqlite3_open("cis427PokemonCardDB2023.sqlite", &db);
    ...
    if (rc != SQLITE_OK) {
        ...
        // Adds Charizard to the database
    ...
    if (rc != SQLITE_OK) {
        ...
        // Adds Bulbasaur to the database
    ...
    if (rc != SQLITE_OK) {
        ...
        // Adds Jigglypuff to the database
